...
In this branch we had more data and had less variables because of that all of the data that we got were all different but in the number 2 branch we had less data but more variables so we had a better chance of getting something that was similar.
